...
class SAINT(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.mask_embeds_cat = nn.Embedding(self.num_categories*3, self.dim)
        self.mask_embeds_cont = nn.Embedding(self.num_continuous*3, self.dim)
        self.single_mask = nn.Embedding(2, self.dim)
        ##
        self.cat_mask = nn.Embedding(self.num_categories+1, self.dim)
        self.con_mask = nn.Embedding(self.num_continuous+1, self.dim)
